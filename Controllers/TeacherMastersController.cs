...
namespace ISMLogin.Controllers
{
    ...
    public class TeacherMastersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Name,Address,Email,Mobile,Designatin")] TeacherMaster teacherMaster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Name,Address,Email,Mobile,Designatin")] TeacherMaster teacherMaster)
        {
            if (ModelState.IsValid)
            {
